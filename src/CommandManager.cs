...
namespace Mercurius {
    public static class CommandManager {
        ...
        // public static Dictionary<string, BaseCommand> Commands { get; private set; }
        ...
        //         if (Args.Length < 1 && Commands.GetValueOrDefault(Command).HasArgs) {
        ...
        //         await Commands.GetValueOrDefault(Command).ExecuteAsync(Args);
        //         return string.Empty;
